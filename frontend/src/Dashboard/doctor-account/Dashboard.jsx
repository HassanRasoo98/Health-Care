            ...
            <div className='lg:col-span-2'>
              {data.isApproved === 'pending' && (
                <div className='flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg'>
                  ...
                  >
                    <path
                      fillRule='evenodd'
                      d='M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001
              ...
              <div className='mt-8'>
                {tab === 'overview' && (<div>
                  ...
                  leading-4 lg:text-[16px] lg:leading-6 font-semibold' > Surgeon</span>

                      <h3 className='text-[22px] leading-9 font-bold text-headingColor mt-3'>Wassay Ahmad</h3>
                  ...
                  <DoctorAbout className='px-2' name={data.name} about={data.about} qualification={data.qualifications}
